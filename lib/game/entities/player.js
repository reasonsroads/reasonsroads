...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        update: function() {
            ...
            // shoot
            // shoot delay for 1-2
            if( ig.input.pressed('shoot') && this.shootTimer.time > .3 && ig.game.level > 0) {
                this.shootTimer.reset();
                ig.game.spawnEntity( this.activeWeapon, this.pos.x, this.pos.y, {flip:this.flip} );
                console.log('shoot delay')
            }
            // shoot delay 3
            else if( ig.input.pressed('shoot') && this.shootTimer.time > .1 && ig.game.level === 3) {
                this.shootTimer.reset();
                ig.game.spawnEntity( this.activeWeapon, this.pos.x, this.pos.y, {flip:this.flip} );
                console.log('shoot delay')
            }
