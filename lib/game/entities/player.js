...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        update: function() {
            ...
            // super
            // if( ig.input.pressed('super') ) {
            //     if(this.weapon === 0 && ig.game.level === 3){
            //     console.log("hi");
            //     this.shootTimer.reset();
            //     ig.game.spawnEntity( this.activeWeapon = "EntityBullet", this.pos.x, this.pos.y, {flip:this.flip} );}
            // }
            if( ig.input.pressed('super') && this.weapon === 0 && ig.game.level === 3 ) {
                // if(this.weapon === 0 && ig.game.level === 3)
                this.shootTimer.reset();
