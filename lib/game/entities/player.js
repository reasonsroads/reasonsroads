...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        if( ig.input.pressed('shoot') && this.shootTimer.time > .32 && ig.game.level > 0) {
        ...
        else if( ig.input.pressed('shoot') && this.shootTimer.time > .1 && ig.game.level === 3 && this.weapon === 0) {
            this.shootTimer.reset();
            ig.game.spawnEntity( this.activeWeapon, this.pos.x, this.pos.y, {flip:this.flip} );
        ...
        if( ig.input.pressed('switchdown') ) {
            ...
            // adds delay. every level may need a different delay time
            // animation correlates
            if( this.shootTimer.time < .3 && ig.game.level > 0){
                this.currentAnim = this.anims.shoot;
            }
            else if( this.shootTimer.time < .1 && ig.game.level === 3 ){
                this.currentAnim = this.anims.shoot;
            }
