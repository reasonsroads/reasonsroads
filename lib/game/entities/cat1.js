    ...
    speak: function() {
        if (Math.random() < .005) {
          ...
          if(!ig.game.getEntityByName(bubbleName)) {
            var parameters = {text: 'You juggle, Jester. Why are you not being resourseful?', tracks: this.name, margin: 0, lifeSpan: 4, shape: 'square', name: bubbleName, color:[255,255,255]};
