    ...
    speak: function() {
        if (Math.random() < .005) {
          ...
          if(!ig.game.getEntityByName(bubbleName)) {
            var parameters = {text: 'The Knight is strongest you will know. In armor and muscle and lung capacity.', tracks: this.name, margin: 0, lifeSpan: 4, shape: 'square', name: bubbleName, color:[255,255,255]};
