...
MyGame = ig.Game.extend({
    ...
    update: function() {
        ...
        if(!this.showStats){
            ...
            else if(ig.input.state('shoot') && this.level === 4){
                console.log('exit 4')
        ...
        ig.system.setGame(GameOverScreen);
                        ...
                        update: function() {
                            ...
                            if(!this.showStats){
                                ...
                                // level exit if level 1-3
                                if(ig.input.state('shoot') && this.level === 3){
                                if(ig.input.state('shoot') && this.level === 3){
                                    console.log('exit level')
...
if( ig.ua.mobile ) {
	...
	// Touch buttons are anchored to either the left or right and top or bottom
	// screen edge.
	var buttonImage2 = new ig.Image( 'media/touch-buttons_small.png' );
