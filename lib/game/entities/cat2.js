    ...
    speak: function() {
        if (Math.random() < .005) {
          ...
          if(!ig.game.getEntityByName(bubbleName)) {
            var parameters = {text: 'The help of your allies is essential to your survivability.', tracks: this.name, margin: 0, lifeSpan: 4, shape: 'square', name: bubbleName, color:[255,255,255]};
